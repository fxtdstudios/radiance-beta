...
from radiance.nodes.splatting import edit as _edit
from radiance.nodes.splatting import viewer as _viewer

NODE_CLASS_MAPPINGS = {
    **_io.NODE_CLASS_MAPPINGS,
    **_render.NODE_CLASS_MAPPINGS,
    **_train.NODE_CLASS_MAPPINGS,
    **_edit.NODE_CLASS_MAPPINGS,
    **_viewer.NODE_CLASS_MAPPINGS,
}
NODE_DISPLAY_NAME_MAPPINGS = {
    **_io.NODE_DISPLAY_NAME_MAPPINGS,
    **_render.NODE_DISPLAY_NAME_MAPPINGS,
    **_train.NODE_DISPLAY_NAME_MAPPINGS,
    **_edit.NODE_DISPLAY_NAME_MAPPINGS,
    **_viewer.NODE_DISPLAY_NAME_MAPPINGS,
}
