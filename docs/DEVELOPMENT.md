...
- [ ] **VFX efficiency, the rest.** Multipass Estimate's geometry passes (needs its models to test), the EXR passes writer, Compression Artifacts and Scene Cut Detect; GPU timings on the RTX 4080 for both phases. See the project report.
