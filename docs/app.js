const pages = [
  ...
  { id: "nodes-splatting", title: "Gaussian Splatting", file: "built-in-nodes/splatting.md", short: "11", group: "Reference" },
...
function inlineMarkdown(value) {
  return escapeHtml(value)
    ...
    .replace(/\[([^\]]+)\]\(([^)]+)\)/g, (match, text, href) => {
      return `<a href="${routeMarkdownLink(href)}">${text}</a>`;
    });
}
...
function routeMarkdownLink(href) {
  ...
  const map = {
    ...
    "built-in-nodes/io-delivery.md": "#nodes-io",
    "built-in-nodes/generate.md": "#nodes-generate",
    "built-in-nodes/color.md": "#nodes-color",
    "built-in-nodes/hdr-aces.md": "#nodes-hdr",
    "built-in-nodes/vfx.md": "#nodes-vfx",
    "built-in-nodes/pipeline.md": "#nodes-pipeline",
    "built-in-nodes/review.md": "#nodes-review",
    "built-in-nodes/upscale.md": "#nodes-upscale",
    "built-in-nodes/video.md": "#nodes-video",
    "built-in-nodes/ai-assist.md": "#nodes-ai",
  };
  return map[clean] || href;
}
...
\`\`\`text
http://127.0.0.1:8787/#${page.id}
\`\`\`

The source file for this page is \`docs/${page.file}\`.`;
    if (fallback) {
