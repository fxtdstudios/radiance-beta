    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "sigmaColor": ("FLOAT", {"default": 0.15, "min": 0.0, "max": 10.0, "step": 0.01}),
                "sigmaSpace": ("FLOAT", {"default": 75.0, "min": 0.0, "max": 500.0, "step": 0.1}),
            }
        }
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "RadianceDenoise": "Radiance 32-bit Denoise"
}
