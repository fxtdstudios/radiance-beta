...
import torch
try:
    from .film.camera_profiles import CAMERAS, LENSES, APERTURES, SHUTTER_ANGLES, ISO_SETTINGS
except ImportError:
    from film.camera_profiles import CAMERAS, LENSES, APERTURES, SHUTTER_ANGLES, ISO_SETTINGS
...
class RadianceCinemaStudio:
    ...
    FOCAL_LENGTHS = [
        "Variable / Zoom",
        "8mm Fisheye", "12mm Ultra-Wide", "14mm Ultra-Wide", "16mm Wide",
        "18mm Wide", "21mm Wide", "24mm Wide", "28mm Wide", "32mm Wide",
        "35mm Classic", "40mm Natural", "50mm Standard", "65mm Portrait",
        "75mm Portrait", "85mm Portrait", "100mm Telephoto", "135mm Telephoto",
        "150mm Telephoto", "180mm Telephoto", "200mm Long Lens", "300mm Super Tele"
    ]
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "camera": (cls.CAMERA_LIST, {"default": cls.CAMERA_LIST[1] if len(cls.CAMERA_LIST) > 1 else "None"}),
                "lens_series": (cls.LENS_LIST, {"default": cls.LENS_LIST[1] if len(cls.LENS_LIST) > 1 else "None"}),
                "focal_length": (cls.FOCAL_LENGTHS, {"default": "50mm Standard"}),
                "aperture": (APERTURES, {"default": "T2.0 (Cinematic Separation)"}),
                "shutter": (SHUTTER_ANGLES, {"default": "180° (Standard Motion - 1/48s)"}),
                "iso": (ISO_SETTINGS, {"default": "800 ISO (Native Digital)"}),
            },
            "optional": {
                "shot_type": ([
                    "None", "Extreme Wide Shot", "Wide Shot", "Full Shot", 
                    "Medium Wide Shot", "Medium Shot", "Medium Close-Up", 
                    "Close-Up", "Extreme Close-Up", "Macro Detail"
                ], {"default": "Medium Shot"}),
                "camera_movement": ([
                    "None", "Static Tripod", "Handheld Shake", "Steadicam Smooth", 
                    "Dolly In", "Dolly Out", "Truck Left", "Truck Right",
                    "Crane Up", "Crane Down", "Dutch Angle", "Whip Pan"
                ], {"default": "None"}),
            }
        }
    ...
    def generate_cinema_prompt(self, base_prompt, camera, lens_series, focal_length, 
                              aperture, shutter, iso, shot_type="None", camera_movement="None"):
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "RadianceCinemaStudio": "◎ Radiance Manager"
}
